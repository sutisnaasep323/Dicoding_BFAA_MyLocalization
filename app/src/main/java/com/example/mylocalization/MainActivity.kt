...
class MainActivity : AppCompatActivity() {
    ...
    // tampilkan menu dan atur action ketika menu tersebut diklik
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.itemId == R.id.action_change_settings){
            //Baris intent di bawah akan membawa kita pada halaman penentuan bahasa di perangkat Android
            // disini ketika kita ubah bahasa maka perangkat pun akan mengganti bahasa
